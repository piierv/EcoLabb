...
**Lugar y modalidad:** Universidad Mayor / [Por completar].
...
> Reemplazar `foto_equipo.jpg` por la fotografía real del equipo.
...
|---|---|---|---|
| Piero Valdivia Meneses | [Por completar] | Coordinación y seguimiento | Coordinar las actividades, organizar reuniones, registrar acuerdos y realizar seguimiento de los avances. |
| Marco Díaz Estrada | [Por completar] | Investigación y diagnóstico | Investigar el flujo de residuos seleccionado, recopilar antecedentes y apoyar la cuantificación del problema. |
| José Obrecht Egaña | [Por completar] | Diseño y prototipado | Participar en la generación de alternativas, diseño de la solución y desarrollo del prototipo o procedimiento. |
| Paulo García Arce | [Por completar] | Documentación y análisis | Organizar evidencias, datos y resultados, mantener la bitácora y apoyar el análisis del proyecto. |
...
|---|---|---|---|
| Piero Valdivia Meneses | COORDINACIÓN Y SEGUIMIENTO | Me comprometo a coordinar el trabajo del equipo, registrar acuerdos, responsables y fechas, y realizar seguimiento semanal de los compromisos para mantener actualizado el avance del proyecto. | Primeras etapas del proyecto |
...
| José Obrecht Egaña | DISEÑO Y PROTOTIPADO | Me comprometo a participar en la generación y selección de alternativas y desarrollar, junto al equipo, un prototipo o procedimiento que permita demostrar la factibilidad técnica de la propuesta antes de la entrega final. | Desarrollo del proyecto |
